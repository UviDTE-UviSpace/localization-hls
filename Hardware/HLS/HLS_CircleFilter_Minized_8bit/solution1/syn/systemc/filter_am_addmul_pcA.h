...
// ==============================================================
#ifndef __filter_am_addmul_pcA__HH__
#define __filter_am_addmul_pcA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_am_addmul_pcA) {
    ...
    SC_CTOR(filter_am_addmul_pcA):  simcore_am_0_U ("simcore_am_0_U") {
