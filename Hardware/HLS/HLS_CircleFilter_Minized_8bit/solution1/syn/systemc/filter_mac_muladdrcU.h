...
// ==============================================================
#ifndef __filter_mac_muladdrcU__HH__
#define __filter_mac_muladdrcU__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdrcU) {
    ...
    SC_CTOR(filter_mac_muladdrcU):  simcore_mac_7_U ("simcore_mac_7_U") {
