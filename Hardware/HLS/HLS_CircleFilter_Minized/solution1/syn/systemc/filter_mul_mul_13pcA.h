...
// ==============================================================
#ifndef __filter_mul_mul_13pcA__HH__
#define __filter_mul_mul_13pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mul_mul_13pcA) {
    ...
    SC_CTOR(filter_mul_mul_13pcA):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
