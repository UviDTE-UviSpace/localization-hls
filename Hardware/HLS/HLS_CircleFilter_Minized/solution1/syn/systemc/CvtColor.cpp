...
void CvtColor::thread_i_fu_213_p2() {
    i_fu_213_p2 = (!i_0_i_reg_182.read().is_01() || !ap_const_lv9_1.is_01())? sc_lv<9>(): (sc_biguint<9>(i_0_i_reg_182.read()) + sc_biguint<9>(ap_const_lv9_1));
}

void CvtColor::thread_icmp_ln1967_fu_208_p2() {
    icmp_ln1967_fu_208_p2 = (!zext_ln1967_fu_204_p1.read().is_01() || !p_src_rows_V_read_reg_239.read().is_01())? sc_lv<1>(): (sc_bigint<10>(zext_ln1967_fu_204_p1.read()) < sc_bigint<10>(p_src_rows_V_read_reg_239.read()));
}

void CvtColor::thread_icmp_ln1968_fu_223_p2() {
    icmp_ln1968_fu_223_p2 = (!zext_ln1968_fu_219_p1.read().is_01() || !p_src_cols_V_read_reg_234.read().is_01())? sc_lv<1>(): (sc_bigint<11>(zext_ln1968_fu_219_p1.read()) < sc_bigint<11>(p_src_cols_V_read_reg_234.read()));
}
...
void CvtColor::thread_j_fu_228_p2() {
    j_fu_228_p2 = (!j_0_i_reg_193.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(j_0_i_reg_193.read()) + sc_biguint<10>(ap_const_lv10_1));
}
...
void CvtColor::thread_zext_ln1967_fu_204_p1() {
    zext_ln1967_fu_204_p1 = esl_zext<10,9>(i_0_i_reg_182.read());
}

void CvtColor::thread_zext_ln1968_fu_219_p1() {
    zext_ln1968_fu_219_p1 = esl_zext<11,10>(j_0_i_reg_193.read());
}
