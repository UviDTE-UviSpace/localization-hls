...
// ==============================================================
#ifndef __filter_mac_muladdibs__HH__
#define __filter_mac_muladdibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdibs) {
    ...
    SC_CTOR(filter_mac_muladdibs):  simcore_mac_2_U ("simcore_mac_2_U") {
