...
// ==============================================================
#ifndef __filter_mac_muladdmb6__HH__
#define __filter_mac_muladdmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdmb6) {
    ...
    SC_CTOR(filter_mac_muladdmb6):  simcore_mac_5_U ("simcore_mac_5_U") {
