...
// ==============================================================
#ifndef __filter_mac_muladdkbM__HH__
#define __filter_mac_muladdkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdkbM) {
    ...
    SC_CTOR(filter_mac_muladdkbM):  simcore_mac_3_U ("simcore_mac_3_U") {
