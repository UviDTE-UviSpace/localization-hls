...
// ==============================================================
#ifndef __filter_am_addmul_sc4__HH__
#define __filter_am_addmul_sc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_am_addmul_sc4) {
    ...
    SC_CTOR(filter_am_addmul_sc4):  simcore_am_0_U ("simcore_am_0_U") {
