...
// ==============================================================
#ifndef __filter_mul_mul_12rcU__HH__
#define __filter_mul_mul_12rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mul_mul_12rcU) {
    ...
    SC_CTOR(filter_mul_mul_12rcU):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
