...
// ==============================================================
#ifndef __filter_mac_muladdudo__HH__
#define __filter_mac_muladdudo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdudo) {
    ...
    SC_CTOR(filter_mac_muladdudo):  simcore_mac_9_U ("simcore_mac_9_U") {
