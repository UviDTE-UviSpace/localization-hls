...
// ==============================================================
#ifndef __filter_mac_muladdwdI__HH__
#define __filter_mac_muladdwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdwdI) {
    ...
    SC_CTOR(filter_mac_muladdwdI):  simcore_mac_11_U ("simcore_mac_11_U") {
