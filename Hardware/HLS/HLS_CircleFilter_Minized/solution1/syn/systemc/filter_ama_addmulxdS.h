...
// ==============================================================
#ifndef __filter_ama_addmulxdS__HH__
#define __filter_ama_addmulxdS__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_ama_addmulxdS) {
    ...
    SC_CTOR(filter_ama_addmulxdS):  simcore_ama_0_U ("simcore_ama_0_U") {
