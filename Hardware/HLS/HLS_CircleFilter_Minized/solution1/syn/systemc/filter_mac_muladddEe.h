...
// ==============================================================
#ifndef __filter_mac_muladddEe__HH__
#define __filter_mac_muladddEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladddEe) {
    ...
    SC_CTOR(filter_mac_muladddEe):  simcore_mac_1_U ("simcore_mac_1_U") {
