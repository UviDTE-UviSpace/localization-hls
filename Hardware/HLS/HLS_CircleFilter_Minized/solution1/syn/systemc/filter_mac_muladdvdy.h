...
// ==============================================================
#ifndef __filter_mac_muladdvdy__HH__
#define __filter_mac_muladdvdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdvdy) {
    ...
    SC_CTOR(filter_mac_muladdvdy):  simcore_mac_10_U ("simcore_mac_10_U") {
