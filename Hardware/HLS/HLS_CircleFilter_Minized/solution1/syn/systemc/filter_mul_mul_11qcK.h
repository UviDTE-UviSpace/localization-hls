...
// ==============================================================
#ifndef __filter_mul_mul_11qcK__HH__
#define __filter_mul_mul_11qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mul_mul_11qcK) {
    ...
    SC_CTOR(filter_mul_mul_11qcK):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
