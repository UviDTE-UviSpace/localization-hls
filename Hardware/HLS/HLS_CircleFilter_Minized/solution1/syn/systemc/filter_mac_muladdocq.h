...
// ==============================================================
#ifndef __filter_mac_muladdocq__HH__
#define __filter_mac_muladdocq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdocq) {
    ...
    SC_CTOR(filter_mac_muladdocq):  simcore_mac_7_U ("simcore_mac_7_U") {
