...
// ==============================================================
#ifndef __filter_mac_muladdlbW__HH__
#define __filter_mac_muladdlbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdlbW) {
    ...
    SC_CTOR(filter_mac_muladdlbW):  simcore_mac_5_U ("simcore_mac_5_U") {
