...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "filter.autotvin.dat"
	set constFileTvOut       "filter.autotvout.dat"
	set constFileHdlTvIn     "filter.autohdltvin.dat"
	set constFileHdlTvOut    "filter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
