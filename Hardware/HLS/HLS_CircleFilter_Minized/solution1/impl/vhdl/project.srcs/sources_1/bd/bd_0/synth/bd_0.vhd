...
architecture STRUCTURE of bd_0 is
  ...
  attribute X_INTERFACE_PARAMETER of video_in_tdata : signal is "XIL_INTERFACENAME video_in, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
  ...
  attribute X_INTERFACE_PARAMETER of video_out_tdata : signal is "XIL_INTERFACENAME video_out, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 4, TDEST_WIDTH 1, TID_WIDTH 1, TUSER_WIDTH 1";
...
begin
  ...
  video_in_0_1_TDATA(31 downto 0) <= video_in_tdata(31 downto 0);
  video_in_0_1_TDEST(0) <= video_in_tdest(0);
  video_in_0_1_TID(0) <= video_in_tid(0);
  video_in_0_1_TKEEP(3 downto 0) <= video_in_tkeep(3 downto 0);
  video_in_0_1_TLAST(0) <= video_in_tlast(0);
  video_in_0_1_TSTRB(3 downto 0) <= video_in_tstrb(3 downto 0);
  video_in_0_1_TUSER(0) <= video_in_tuser(0);
  video_in_0_1_TVALID <= video_in_tvalid;
  video_in_tready <= video_in_0_1_TREADY;
  video_out_tdata(31 downto 0) <= hls_inst_video_out_TDATA(31 downto 0);
  video_out_tdest(0) <= hls_inst_video_out_TDEST(0);
  video_out_tid(0) <= hls_inst_video_out_TID(0);
  video_out_tkeep(3 downto 0) <= hls_inst_video_out_TKEEP(3 downto 0);
  video_out_tlast(0) <= hls_inst_video_out_TLAST(0);
  video_out_tstrb(3 downto 0) <= hls_inst_video_out_TSTRB(3 downto 0);
...
hls_inst: component bd_0_hls_inst_0
     port map (
      ...
      video_in_TDATA(31 downto 0) => video_in_0_1_TDATA(31 downto 0),
      video_in_TDEST(0) => video_in_0_1_TDEST(0),
      video_in_TID(0) => video_in_0_1_TID(0),
      video_in_TKEEP(3 downto 0) => video_in_0_1_TKEEP(3 downto 0),
      video_in_TLAST(0) => video_in_0_1_TLAST(0),
      video_in_TREADY => video_in_0_1_TREADY,
      video_in_TSTRB(3 downto 0) => video_in_0_1_TSTRB(3 downto 0),
