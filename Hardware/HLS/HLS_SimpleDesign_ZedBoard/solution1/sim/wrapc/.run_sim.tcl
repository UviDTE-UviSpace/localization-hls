...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "passthrough.autotvin.dat"
	set constFileTvOut       "passthrough.autotvout.dat"
	set constFileHdlTvIn     "passthrough.autohdltvin.dat"
	set constFileHdlTvOut    "passthrough.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
