...
if {[file isfile passthrough.autotvin.dat]} {
	file delete -force passthrough.autotvin.dat
}

if {[file isfile passthrough.autotvout.dat]} {
	file delete -force passthrough.autotvout.dat
}
