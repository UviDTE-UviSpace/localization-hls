...
AXIvideo2Mat_DMA::AXIvideo2Mat_DMA(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_2_reg_196, "t_V_2_reg_196");
...
void AXIvideo2Mat_DMA::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_2_reg_196 = j_V_fu_231_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln22_fu_215_p2.read()))) {
...
void AXIvideo2Mat_DMA::thread_icmp_ln25_fu_226_p2() {
    icmp_ln25_fu_226_p2 = (!t_V_2_reg_196.read().is_01() || !cols_V_reg_246.read().is_01())? sc_lv<1>(): sc_lv<1>(t_V_2_reg_196.read() == cols_V_reg_246.read());
}
...
void AXIvideo2Mat_DMA::thread_j_V_fu_231_p2() {
    j_V_fu_231_p2 = (!t_V_2_reg_196.read().is_01() || !ap_const_lv32_1.is_01())? sc_lv<32>(): (sc_biguint<32>(t_V_2_reg_196.read()) + sc_biguint<32>(ap_const_lv32_1));
}
