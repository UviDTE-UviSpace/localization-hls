...
architecture behav of AXIvideo2Mat_DMA is 
    ...
    signal icmp_ln25_fu_226_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal img_rows_V_blk_n : STD_LOGIC;
    signal img_cols_V_blk_n : STD_LOGIC;
    signal img_data_stream_V_blk_n : STD_LOGIC;
    signal ap_enable_reg_pp0_iter1 : STD_LOGIC := '0';
    signal icmp_ln25_reg_260 : STD_LOGIC_VECTOR (0 downto 0);
    signal img_rows_V_out_blk_n : STD_LOGIC;
    signal img_cols_V_out_blk_n : STD_LOGIC;
    signal t_V_4_reg_196 : STD_LOGIC_VECTOR (31 downto 0);
    signal rows_V_fu_207_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal rows_V_reg_241 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal cols_V_fu_211_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal j_V_fu_231_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_data_V_reg_269 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal rows_V_fu_207_p0 : STD_LOGIC_VECTOR (9 downto 0);
    signal cols_V_fu_211_p0 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln22_fu_215_p2 = ap_const_lv1_1))) then 
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_logic_1 = ap_condition_pp0_exit_iter0_state3) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
                    ap_enable_reg_pp0_iter0 <= ap_const_logic_0;
                elsif (((icmp_ln22_fu_215_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    t_V_4_reg_196_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tmp_data_V_reg_269 <= video_in_TDATA_int;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (real_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, img_rows_V_empty_n, img_cols_V_empty_n, img_rows_V_out_full_n, img_cols_V_out_full_n, ap_enable_reg_pp0_iter0, icmp_ln25_fu_226_p2, icmp_ln22_fu_215_p2, ap_CS_fsm_state2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln22_fu_215_p2 = ap_const_lv1_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                end if;
            when ap_ST_fsm_pp0_stage0 => 
                if (not(((icmp_ln25_fu_226_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp0_stage0;
                elsif (((icmp_ln25_fu_226_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln25_fu_226_p2, ap_enable_reg_pp0_iter1, icmp_ln25_reg_260, video_in_TVALID_int)
    begin
                ap_block_pp0_stage0_01001 <= (((icmp_ln25_reg_260 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (video_in_TVALID_int = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln25_fu_226_p2, ap_enable_reg_pp0_iter1, icmp_ln25_reg_260, video_in_TVALID_int)
    begin
                ap_block_pp0_stage0_11001 <= (((icmp_ln25_reg_260 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (video_in_TVALID_int = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp0_iter0, icmp_ln25_fu_226_p2, ap_enable_reg_pp0_iter1, icmp_ln25_reg_260, video_in_TVALID_int)
    begin
                ap_block_pp0_stage0_subdone <= (((icmp_ln25_reg_260 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (video_in_TVALID_int = ap_const_logic_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1)));
    end process;
    ...
    ap_block_state3_pp0_stage0_iter0_assign_proc : process(icmp_ln25_fu_226_p2, video_in_TVALID_int)
    begin
                ap_block_state3_pp0_stage0_iter0 <= ((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (video_in_TVALID_int = ap_const_logic_0));
    end process;


    ap_block_state4_pp0_stage0_iter1_assign_proc : process(img_data_stream_V_full_n, icmp_ln25_reg_260)
    begin
                ap_block_state4_pp0_stage0_iter1 <= ((icmp_ln25_reg_260 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0));
    end process;


    ap_condition_pp0_exit_iter0_state3_assign_proc : process(icmp_ln25_fu_226_p2)
    begin
        if ((icmp_ln25_fu_226_p2 = ap_const_lv1_1)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, icmp_ln22_fu_215_p2, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln22_fu_215_p2 = ap_const_lv1_1))) then 
    ...
    cols_V_fu_211_p0 <= img_cols_V_dout;
        cols_V_fu_211_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(cols_V_fu_211_p0),32));

    i_V_fu_220_p2 <= std_logic_vector(unsigned(t_V_reg_185) + unsigned(ap_const_lv32_1));
    icmp_ln22_fu_215_p2 <= "1" when (t_V_reg_185 = rows_V_reg_241) else "0";
    icmp_ln25_fu_226_p2 <= "1" when (t_V_4_reg_196 = cols_V_reg_246) else "0";
    ...
    img_data_stream_V_blk_n_assign_proc : process(img_data_stream_V_full_n, ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln25_reg_260)
    begin
        if (((icmp_ln25_reg_260 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    img_data_stream_V_din <= tmp_data_V_reg_269;

    img_data_stream_V_write_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln25_reg_260, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln25_reg_260 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    internal_ap_ready_assign_proc : process(icmp_ln22_fu_215_p2, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln22_fu_215_p2 = ap_const_lv1_1))) then 
    ...
    j_V_fu_231_p2 <= std_logic_vector(unsigned(t_V_4_reg_196) + unsigned(ap_const_lv32_1));
    ...
    rows_V_fu_207_p0 <= img_rows_V_dout;
        rows_V_fu_207_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(rows_V_fu_207_p0),32));
    ...
    video_in_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0, icmp_ln25_fu_226_p2, video_in_TVALID_int)
    begin
        if (((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    video_in_TREADY_int_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, icmp_ln25_fu_226_p2, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln25_fu_226_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
