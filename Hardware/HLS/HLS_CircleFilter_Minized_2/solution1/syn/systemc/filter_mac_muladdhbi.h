...
// ==============================================================
#ifndef __filter_mac_muladdhbi__HH__
#define __filter_mac_muladdhbi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdhbi) {
    ...
    SC_CTOR(filter_mac_muladdhbi):  simcore_mac_1_U ("simcore_mac_1_U") {
