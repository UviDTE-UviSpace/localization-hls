...
// ==============================================================
#ifndef __filter_mac_muladdg8j__HH__
#define __filter_mac_muladdg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdg8j) {
    ...
    SC_CTOR(filter_mac_muladdg8j):  simcore_mac_0_U ("simcore_mac_0_U") {
