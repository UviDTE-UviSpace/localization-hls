...
architecture behav of blur_image is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "blur_image,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z007s-clg225-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.268000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=442,HLS_SYN_LUT=759,HLS_VERSION=2019_2}";
    ...
    signal img_1_rows_V_c4_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal img_1_rows_V_c4_empty_n : STD_LOGIC;
    signal img_1_cols_V_c5_full_n : STD_LOGIC;
    signal img_1_cols_V_c5_dout : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    img_1_rows_V_c4_U : component fifo_w10_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    img_1_cols_V_c5_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
