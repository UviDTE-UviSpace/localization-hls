...
if {[file isfile blur_image.autotvin.dat]} {
	file delete -force blur_image.autotvin.dat
}

if {[file isfile blur_image.autotvout.dat]} {
	file delete -force blur_image.autotvout.dat
}
