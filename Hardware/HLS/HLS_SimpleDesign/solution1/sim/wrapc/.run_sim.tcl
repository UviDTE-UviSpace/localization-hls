...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "blur_image.autotvin.dat"
	set constFileTvOut       "blur_image.autotvout.dat"
	set constFileHdlTvIn     "blur_image.autohdltvin.dat"
	set constFileHdlTvOut    "blur_image.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
