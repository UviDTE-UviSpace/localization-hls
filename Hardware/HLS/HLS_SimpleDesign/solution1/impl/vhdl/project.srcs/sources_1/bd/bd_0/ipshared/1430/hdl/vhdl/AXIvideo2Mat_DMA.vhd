...
begin
    ...
    icmp_ln25_fu_226_p2 <= "1" when (t_V_2_reg_196 = cols_V_reg_246) else "0";
    ...
    j_V_fu_231_p2 <= std_logic_vector(unsigned(t_V_2_reg_196) + unsigned(ap_const_lv32_1));
