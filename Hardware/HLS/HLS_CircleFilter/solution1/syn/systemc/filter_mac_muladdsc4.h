...
// ==============================================================
#ifndef __filter_mac_muladdsc4__HH__
#define __filter_mac_muladdsc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdsc4) {
    ...
    SC_CTOR(filter_mac_muladdsc4):  simcore_mac_8_U ("simcore_mac_8_U") {
