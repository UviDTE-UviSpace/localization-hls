...
// ==============================================================
#ifndef __filter_ama_addmuludo__HH__
#define __filter_ama_addmuludo__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_ama_addmuludo) {
    ...
    SC_CTOR(filter_ama_addmuludo):  simcore_ama_0_U ("simcore_ama_0_U") {
