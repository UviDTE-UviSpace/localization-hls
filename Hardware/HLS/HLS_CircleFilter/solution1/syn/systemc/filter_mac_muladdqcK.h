...
// ==============================================================
#ifndef __filter_mac_muladdqcK__HH__
#define __filter_mac_muladdqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(filter_mac_muladdqcK) {
    ...
    SC_CTOR(filter_mac_muladdqcK):  simcore_mac_6_U ("simcore_mac_6_U") {
