...
wire   [0:0] or_ln76_fu_386_p2;
wire    ap_CS_fsm_state8;
wire   [0:0] ap_phi_mux_eol_2_i_phi_fu_327_p4;
reg    img_rows_V_blk_n;
reg    img_cols_V_blk_n;
reg    img_data_stream_V_blk_n;
reg    ap_enable_reg_pp1_iter1;
reg   [0:0] icmp_ln73_reg_440;
reg    img_rows_V_out_blk_n;
reg    img_cols_V_out_blk_n;
reg   [0:0] eol_reg_230;
reg   [15:0] axi_data_V_1_i_reg_241;
reg   [31:0] t_V_4_reg_252;
reg   [0:0] eol_0_i_reg_263;
reg   [0:0] axi_last_V_2_i_reg_275;
reg   [15:0] p_Val2_s_reg_288;
wire  signed [31:0] rows_V_fu_344_p1;
reg  signed [31:0] rows_V_reg_401;
reg    ap_block_state1;
wire  signed [31:0] cols_V_fu_348_p1;
reg  signed [31:0] cols_V_reg_406;
reg   [15:0] tmp_data_V_reg_411;
reg   [0:0] tmp_last_V_reg_419;
wire   [0:0] icmp_ln71_fu_361_p2;
wire    ap_CS_fsm_state4;
wire   [31:0] i_V_fu_366_p2;
reg   [31:0] i_V_reg_435;
reg    ap_predicate_op65_read_state5;
reg    ap_block_state5_pp1_stage0_iter0;
reg    ap_block_state6_pp1_stage0_iter1;
reg    ap_block_pp1_stage0_11001;
wire   [31:0] j_V_fu_377_p2;
wire   [7:0] tmp_fu_392_p1;
reg   [7:0] tmp_reg_453;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln71_fu_361_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp1_stage0) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((icmp_ln71_fu_361_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln73_reg_440 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    ...
    end else if ((~((eol_2_i_reg_324 == 1'd0) & (video_in_TVALID_int == 1'b0)) & (eol_2_i_reg_324 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_184)) begin
        if (((or_ln76_fu_386_p2 == 1'd1) & (icmp_ln73_fu_372_p2 == 1'd0))) begin
            axi_last_V_2_i_reg_275 <= ap_phi_mux_eol_phi_fu_233_p4;
        end else if (((or_ln76_fu_386_p2 == 1'd0) & (icmp_ln73_fu_372_p2 == 1'd0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln73_fu_372_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        sof_1_i_fu_142 <= 1'd0;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln73_fu_372_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_reg_453 <= tmp_fu_392_p1;
    end
end

always @ (*) begin
    if ((icmp_ln73_fu_372_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (icmp_ln71_fu_361_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln73_reg_440 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1))) begin
...
always @ (*) begin
    if ((icmp_ln73_fu_372_p2 == 1'd0)) begin
        if ((or_ln76_fu_386_p2 == 1'd1)) begin
            ap_phi_mux_p_Val2_s_phi_fu_292_p4 = ap_phi_mux_axi_data_V_1_i_phi_fu_244_p4;
        end else if ((or_ln76_fu_386_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) | ((or_ln76_fu_386_p2 == 1'd0) & (icmp_ln73_fu_372_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0)) | ((eol_2_i_reg_324 == 1'd0) & (1'b1 == ap_CS_fsm_state8)))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_predicate_op65_read_state5 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001)) | ((video_in_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2)) | (~((eol_2_i_reg_324 == 1'd0) & (video_in_TVALID_int == 1'b0)) & (eol_2_i_reg_324 == 1'd0) & (1'b1 == ap_CS_fsm_state8)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((tmp_user_V_fu_352_p1 == 1'd0) & (video_in_TVALID_int == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((video_in_TVALID_int == 1'b1) & (tmp_user_V_fu_352_p1 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((icmp_ln73_fu_372_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((icmp_ln73_fu_372_p2 == 1'd1) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b0 == ap_block_pp1_stage0_subdone))) begin
        ...
        ap_ST_fsm_state8 : begin
            if ((~((eol_2_i_reg_324 == 1'd0) & (video_in_TVALID_int == 1'b0)) & (eol_2_i_reg_324 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
                ap_NS_fsm = ap_ST_fsm_state8;
            end else if ((~((eol_2_i_reg_324 == 1'd0) & (video_in_TVALID_int == 1'b0)) & (1'b1 == ap_CS_fsm_state8) & (ap_phi_mux_eol_2_i_phi_fu_327_p4 == 1'd1))) begin
...
always @ (*) begin
    ap_block_pp1_stage0_01001 = (((video_in_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((icmp_ln73_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_11001 = (((video_in_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((icmp_ln73_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = (((video_in_TVALID_int == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (ap_predicate_op65_read_state5 == 1'b1)) | ((icmp_ln73_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0) & (ap_enable_reg_pp1_iter1 == 1'b1)));
end
...
always @ (*) begin
    ap_block_state6_pp1_stage0_iter1 = ((icmp_ln73_reg_440 == 1'd0) & (img_data_stream_V_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state8 = ((eol_2_i_reg_324 == 1'd0) & (video_in_TVALID_int == 1'b0));
end
...
assign ap_phi_mux_eol_2_i_phi_fu_327_p4 = eol_2_i_reg_324;
...
always @ (*) begin
    ap_predicate_op65_read_state5 = ((or_ln76_fu_386_p2 == 1'd0) & (icmp_ln73_fu_372_p2 == 1'd0));
end

assign ap_ready = internal_ap_ready;

assign cols_V_fu_348_p0 = img_cols_V_dout;

assign cols_V_fu_348_p1 = cols_V_fu_348_p0;

assign i_V_fu_366_p2 = (t_V_reg_219 + 32'd1);

assign icmp_ln71_fu_361_p2 = ((t_V_reg_219 == rows_V_reg_401) ? 1'b1 : 1'b0);

assign icmp_ln73_fu_372_p2 = ((t_V_4_reg_252 == cols_V_reg_406) ? 1'b1 : 1'b0);

assign img_cols_V_out_din = img_cols_V_dout;

assign img_data_stream_V_din = tmp_reg_453;

assign img_rows_V_out_din = img_rows_V_dout;

assign j_V_fu_377_p2 = (t_V_4_reg_252 + 32'd1);

assign or_ln76_fu_386_p2 = (sof_1_i_fu_142 | ap_phi_mux_eol_0_i_phi_fu_267_p4);

assign rows_V_fu_344_p0 = img_rows_V_dout;

assign rows_V_fu_344_p1 = rows_V_fu_344_p0;

assign start_out = real_start;

assign tmp_fu_392_p1 = ap_phi_mux_p_Val2_s_phi_fu_292_p4[7:0];

assign tmp_user_V_fu_352_p1 = video_in_TUSER_int;
