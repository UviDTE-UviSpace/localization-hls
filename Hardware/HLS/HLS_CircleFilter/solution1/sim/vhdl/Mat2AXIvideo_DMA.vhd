...
begin
    ...
    icmp_ln54_fu_229_p2 <= "1" when (t_V_2_reg_170 = cols_V_reg_259) else "0";
    ...
    j_V_fu_234_p2 <= std_logic_vector(unsigned(t_V_2_reg_170) + unsigned(ap_const_lv32_1));
    ...
    zext_ln879_1_fu_240_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t_V_2_reg_170),33));
