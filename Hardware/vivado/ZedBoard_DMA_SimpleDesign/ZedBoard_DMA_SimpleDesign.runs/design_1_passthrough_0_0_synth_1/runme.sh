...
HD_PWD='C:/localization-hls/Hardware/vivado/ZedBoard_DMA_SimpleDesign/ZedBoard_DMA_SimpleDesign.runs/design_1_passthrough_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_passthrough_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_passthrough_0_0.tcl
