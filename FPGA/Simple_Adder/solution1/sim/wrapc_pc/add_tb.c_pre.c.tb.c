...
// ==============================================================
# 1 "C:/localization-hls/FPGA/add_tb.c"
# 1 "C:/localization-hls/FPGA/add_tb.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/localization-hls/FPGA/add_tb.c" 2
...
# 1 "C:/localization-hls/FPGA/add_ex.h" 1
int add_ex(int in_a, int in_b);
# 2 "C:/localization-hls/FPGA/add_tb.c" 2


#ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_add_ex.h"
#endif
# 4 "C:/localization-hls/FPGA/add_tb.c"
void main()
{
 int i;
 int result;
 ...
 for(i=0;i<10;i++){
  ...
  result = 
#ifndef HLS_FASTSIM
#define add_ex AESL_WRAP_add_ex
#endif
# 15 "C:/localization-hls/FPGA/add_tb.c"
add_ex(rand_a, rand_b);
#undef add_ex
# 15 "C:/localization-hls/FPGA/add_tb.c"
...
#endif
# 25 "C:/localization-hls/FPGA/add_tb.c"
